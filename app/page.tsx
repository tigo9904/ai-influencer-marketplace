...
const structuredData = {
  ...
  url: "https://your-project.vercel.app", // 🔥 UPDATE THIS WITH YOUR ACTUAL VERCEL URL
  logo: "https://your-project.vercel.app/logo.png", // 🔥 UPDATE THIS WITH YOUR ACTUAL VERCEL URL
  image: "https://your-project.vercel.app/og-image.png", // 🔥 UPDATE THIS WITH YOUR ACTUAL VERCEL URL
  priceRange: "$497-$997",
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50">
        ...
        <footer className="bg-white border-t py-8">
          <div className="container mx-auto px-4 text-center">
            <p className="text-gray-600">© {new Date().getFullYear()} AI Influencer Hub. All rights reserved.</p>
